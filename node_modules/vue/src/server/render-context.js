...
>
    void;
    renderNode: (node: VNode, isRoot: boolean, context: RenderContext) =
>
    void;
    next: () =
>
...
>
    ...
    modules: Array<(node: VNode) =
> ?
    string
>
    ;
    directives: Object;
    isUnaryTag: (tag: string) =
>
    boolean;
...
function normalizeAsync(cache, method) {
    ...
    if (isUndef(fn)) {
        ...
        return (key, cb) =
    >
        fn.call(cache, key, cb)
    } else {
        return (key, cb) =
    >
        cb(fn.call(cache, key))
    }
}
