...
// props bindings
export function applyModelTransform(el
...
export function genDOMPropSegments(props
...
export function genClassSegments(staticClass
...
export function genStyleSegments(staticStyle
